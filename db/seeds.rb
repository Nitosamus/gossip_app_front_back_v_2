...
20.times do 
	puts Gossip.create(title: Faker::Hipster.sentence(word_count: 3, supplemental: true, random_words_to_add: 2),
...
20.times do
	puts Comment.create(content: Faker::Hipster.paragraph(sentence_count: rand(1..6), supplemental: true, random_sentences_to_add: rand(2..4)),
